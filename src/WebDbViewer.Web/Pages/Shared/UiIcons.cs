...
public static class UiIcons
{
    ...
    /// <summary>Угловые скобки — открыть исходник объекта во вкладке редактора.</summary>
    public static readonly HtmlString Source =
        Stroke("<path d='M5.6 5.4 2.6 8l3 2.6M10.4 5.4 13.4 8l-3 2.6M9.2 3.4 6.8 12.6'/>");
